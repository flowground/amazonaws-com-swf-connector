# ![LOGO](logo.png) Amazon Simple Workflow Service MSP Connector

## Description

A generated MSP connector for the Amazon Simple Workflow Service API (version 2012-01-25).
...
flowground :- Telekom iPaaS / amazonaws-com-swf-connector<br/>
